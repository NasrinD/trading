...
public class CardReaderController implements Serializable {
    ...
    public CardReader getPrinter() {
        return printer;
    }

    public CardReaderController printer(CardReader cardReader) {
        this.printer = cardReader;
        return this;
    }

    public void setPrinter(CardReader cardReader) {
        this.printer = cardReader;
    }
