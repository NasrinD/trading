...
public class BarCodeScannerController implements Serializable {
    ...
    @JsonIgnore
    private BarCodeScanner printer;
    ...
    public BarCodeScanner getPrinter() {
        return printer;
    }

    public BarCodeScannerController printer(BarCodeScanner barCodeScanner) {
        this.printer = barCodeScanner;
        return this;
    }

    public void setPrinter(BarCodeScanner barCodeScanner) {
        this.printer = barCodeScanner;
    }
